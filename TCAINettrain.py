...
#set the path
image_root = './VT5000/Train/RGB/'
gt_root = './VT5000/Train/GT/'
depth_root= './VT5000/Train/T/'
save_path='./BBSNet4_cpts/'
...
if __name__ == '__main__':
    print("Start train...")
    model.load_state_dict(torch.load(save_path + 'BBSNet_epoch_175.pth'))
    print('Loaded model from epoch 175.')
    for epoch in range(176, opt.epoch+1):
